...
public class SecondGcmActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            alert.showAlertDialog(SecondGcmActivity.this,
            ...
            //} else {
                ...
                mRegisterTask = new AsyncTask<Void, Void, Void>() {
                    ...
                    protected Void doInBackground(Void... params) {
                        ...
                        ServerUtilities.register(context,name,email,event,date,college, regId);
                        return null;
                    }
